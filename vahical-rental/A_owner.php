						...
						<div class="table-wrapper">
							...
							<div class="table-title bg-primary">
								<div class="row">
									<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
										<h2 class="ml-lg-2">Owners Details</h2>
									</div>
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									...
									<?php
									if($search){
										$srenter="Select * from owners where (name like '%$search%' OR email like '%$search%')";

									}else{
										$srenter="Select * from owners";
									}
									...
									while ($urow=mysqli_fetch_array($sqry)) 
									{
                                        ...
                                        $pic = !empty($urow['propic']) ? $urow['propic'] : 'images/profile.jpg';
