						...
						<div class="table-wrapper">
							...
							<div class="table-title bg-success">
								<div class="row">
									<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
										<h2 class="ml-lg-2">Approve Bookings</h2>
									</div>
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									...
									if($search){
										// echo $search;
										$bselect="Select * from bookings where owner_id=$oid AND status='Approve' AND (pic_location like '%$search%' OR rtn_location like '%$search%' OR pic_date like '%$search%' OR rtn_date like '%$search%' OR total_cost like '%$search%') ;";
									}
									else{
										$bselect="Select * from bookings where owner_id=$oid && status='Approve'";
									}
									...
									while ($brow=mysqli_fetch_array($bqry)) 
									{
										...
										<th><?= $rtn_date; ?></th>
										<th>
											<a href="O_mng_booking.php?book_id=<?= $bid;?>" class="btn btn-success">
												Manage
											</a>
