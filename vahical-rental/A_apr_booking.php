						...
						<div class="table-wrapper">
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									...
									if($search){
										// echo $search;
										$bselect="Select * from bookings  where status='Approve' AND (pic_location like '%$search%' OR rtn_location like '%$search%' OR pic_date like '%$search%' OR rtn_date like '%$search%' OR total_cost like '%$search%') ;";
									}
									else{
										$bselect="Select * from bookings where status='Approve'";
									}
