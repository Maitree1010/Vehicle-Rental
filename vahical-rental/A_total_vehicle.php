						...
						<div class="table-wrapper">
							...
							<div class="table-title">
								<div class="row">
									<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
										<h2 class="ml-lg-2">Total Vehecle</h2>
									</div>
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									...
									<?php
									if($search){
										$vselect="Select * from vehicles where (address like '%$search%' OR category like '%$search%' OR type like '%$search%' OR transmition like '%$search%' OR model like '%$search%' OR modelname like '%$search%' OR price like '%$search%' OR color like '%$search%' )";

									}else{
										$vselect="Select * from vehicles";
									}
									...
									while ($vrow=mysqli_fetch_array($vqry)) 
									{
										...
										<th><?= $address; ?></th>
										<th>
											<a href="A_mng_vehicle.php?vid=<?= $vehicle_id;?>" class="btn btn-dark">
												View
											</a>
