						...
						<div class="table-wrapper">
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									...
									if($search){
										// echo $search;
										$bselect="Select * from bookings where owner_id=$oid AND (pic_location like '%$search%' OR rtn_location like '%$search%' OR pic_date like '%$search%' OR rtn_date like '%$search%' OR total_cost like '%$search%') ;";
									}
									else{
										$bselect="Select * from bookings where owner_id=$oid";
									}
									...
									while ($brow=mysqli_fetch_array($bqry)) 
									{
										...
										<th><?= $rtn_date; ?></th>
										<th>
											<a href="O_mng_booking.php?book_id=<?= $bid;?>" class="btn btn-dark">
												View
											</a>
